...
Test whether displaying a 'Only 3 left!' urgency badge on low-stock products increases add-to-cart rate on a quick commerce platform (Swiggy Instamart / Blinkit scale).

---

## Business Question

> Did showing the urgency badge increase add-to-cart rate, and is the lift large enough to justify a full platform rollout?
...
Synthetic dataset of 50,000 user sessions generated in Python. All parameters grounded in published industry benchmarks:
...
- **Evening strongest:** 5.28pp lift in Evening vs 2.5pp in Morning
- **Consistent across categories:** All 5 product categories show positive lift
- **Projected impact:** ~₹57 crore additional revenue per month at scale

---

## Recommendation

Roll out the urgency badge platform-wide, prioritising Evening (5pm–9pm) and Night (9pm–12am) slots. Begin with a phased rollout and validate with live traffic for 4 weeks before full deployment.
